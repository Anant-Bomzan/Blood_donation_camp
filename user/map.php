...
<body>
  ...
  <script type="text/javascript">
    ...
    function initMap() {
      var latitude = 26.769353341887037;
      var longitude = 88.37628752359912;
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCGKxpbDZt-KFF6DRvJtqGC2saTW8x9cyc&callback=initMap" async defer></script>
  ...
  <table align="right">
    ...
    <form align="center" class="mp" action="" method="post">
      <p align="center">
        <input align="right" id="latclicked" type="number" name="latitude" step="any" placeholder="Latitude" style="font-size: 18px; width: 180px; height: 30px; border-radius: 10px;">

        <input id="longclicked" type="number" name="longitude" step="any" placeholder="Longitude" style="font-size: 18px; width: 180px; height: 30px; border-radius: 10px;">
